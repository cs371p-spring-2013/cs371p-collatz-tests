...
struct TestCollatz : CppUnit::TestFixture {
    ...
    void test_cycle_1 () {
        const int v = collatz_cycle(1, 1);
        CPPUNIT_ASSERT(v == 1);
    }
    
    void test_cycle_2() {
        const int v = collatz_cycle(3, 1);
        CPPUNIT_ASSERT(v == 8);
    }
    
    void test_cycle_3() {
        const int v = collatz_cycle(10, 1);
        CPPUNIT_ASSERT(v == 7);
    }
    ...
    void test_eval_7 () {
        const int v = collatz_eval(922047, 401342);
    ...
    void test_print_2 () {
        std::ostringstream w;
        collatz_print(w, 22, 1311, 31313);
        CPPUNIT_ASSERT(w.str() == "22 1311 31313\n");}

    void test_print_3 () {
        std::ostringstream w;
        collatz_print(w, 685, 685, 685);
        CPPUNIT_ASSERT(w.str() == "685 685 685\n");}
    ...
    void test_solve_3 () {
        std::istringstream r("261853 570779\n100 200\n201 210\n900 1000\n");
        std::ostringstream w;
        collatz_solve(r, w);
        CPPUNIT_ASSERT(w.str() == "261853 570779 470\n100 200 125\n201 210 89\n900 1000 174\n");}

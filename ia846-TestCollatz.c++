...
struct TestCollatz : CppUnit::TestFixture {
    ...
    void test_eval_5 () {
        const int v = collatz_eval(598, 795);
        const int w = collatz_eval(795, 598);
        CPPUNIT_ASSERT(v == 171 && w == v);}
    ...
    void test_eval_7 () {
        const int v = collatz_eval(936, 937);
        const int w = collatz_eval(937, 937);
        CPPUNIT_ASSERT(v == 174 && v == w);}
    ...
    void test_cycle_length_2() {
        CPPUNIT_ASSERT(cycle_length(999999) == 259); }

...
struct TestCollatz : CppUnit::TestFixture {
    ...
    void test_get_length_1() {
	const int v = get_length(10);
	CPPUNIT_ASSERT(v == 7);}
	
    void test_get_length_2() {
	const int v = get_length(1);
	CPPUNIT_ASSERT(v == 1);}
	
    void test_get_length_3() {
	const int v = get_length(1000000);
    ...
    CPPUNIT_TEST(test_get_length_1);
    CPPUNIT_TEST(test_get_length_2);
    CPPUNIT_TEST(test_get_length_3);

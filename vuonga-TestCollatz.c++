...
struct TestCollatz : CppUnit::TestFixture {
    ...
    void test_eval_5 () {
        const int v = collatz_eval(97, 92);
    ...
    void test_eval_7 () {
        const int v = collatz_eval(25, 20);
        CPPUNIT_ASSERT(v == 24);}

    void test_eval_8 () {
        const int v = collatz_eval(999, 1000);
    ...
    void test_print_4 () {
        ...
        CPPUNIT_ASSERT(w.str() == "150 200 125\n");}
    ...
    void test_solve_3 () {
        std::istringstream r("25 20\n");
        std::ostringstream w;
        collatz_solve(r, w);
        CPPUNIT_ASSERT(w.str() == "25 20 24\n");}

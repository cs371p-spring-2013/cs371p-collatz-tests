...
struct TestCollatz : CppUnit::TestFixture {
    ...
    void test_numbr_1 (){
	 const int v = collatz_numbr(5);
         CPPUNIT_ASSERT(v == 6);}
 
    void test_numbr_2 (){
         const int v = collatz_numbr(22);
         CPPUNIT_ASSERT(v == 16);}

    void test_numbr_3 (){
         const int v = collatz_numbr(4);
         CPPUNIT_ASSERT(v == 3);}
 
    void test_numbr_4 (){
         const int v = collatz_numbr(1000000);
    ...
    CPPUNIT_TEST(test_numbr_1);
    CPPUNIT_TEST(test_numbr_2);
    CPPUNIT_TEST(test_numbr_3);
    CPPUNIT_TEST(test_numbr_4);

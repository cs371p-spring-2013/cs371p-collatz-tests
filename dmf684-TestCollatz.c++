...
struct TestCollatz : CppUnit::TestFixture {
    ...
    void test_read_3 () {
        std::istringstream r("540 240\n");
        int i;
        int j;
        const bool b = collatz_read(r, i, j);
        CPPUNIT_ASSERT(b == true);
        CPPUNIT_ASSERT(i ==   540);
        CPPUNIT_ASSERT(j ==   240);}
    ...
    void test_print_2 () {
        std::ostringstream w;
        collatz_print(w, 5081, 8238, 262);
        CPPUNIT_ASSERT(w.str() == "5081 8238 262\n");}
	
    void test_print_3 () {
        std::ostringstream w;
        collatz_print(w, 342, 864, 171);
        CPPUNIT_ASSERT(w.str() == "342 864 171\n");}
